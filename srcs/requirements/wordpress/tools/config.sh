...
#line 23
sed -i -r "s/define\('DB_NAME', '.*?'\);/define('DB_NAME', '$MYSQL_NAME');/" wp-config.php
#line 26
sed -i -r "s/define\('DB_USER', '.*?'\);/define('DB_USER', '$MYSQL_USER');/" wp-config.php
#line 29
sed -i -r "s/define\('DB_PASSWORD', '.*?'\);/define('DB_PASSWORD', '$MYSQL_PSW');/" wp-config.php


#line 32
sed -i -r "s/define\('DB_HOST', '.*?'\);/define('DB_HOST', 'mariadb');/" wp-config.php
